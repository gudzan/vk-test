...
describe("", () => {
  ...
  test('Проверка наличия карточек репозиториев на экране', async () => {
    const screen = render(<CardList repositories={mockArray} clickEdit={doNothing} clickDelete={doNothing} />);
